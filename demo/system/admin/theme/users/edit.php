	...
	<form method="post" action="<?php echo Url::current(); ?>" novalidate autocomplete="off">
		<fieldset>
			<p>
    			...
    			<input disabled id="real_name" name="real_name" value="<?php echo Input::post('real_name', $user->real_name); ?>">
            ...
            <p>
                ...
                <textarea disabled id="bio" name="bio"><?php echo Input::post('bio', $user->bio); ?></textarea>
		...
		<fieldset>
		    ...
		    <p>
		        ...
		        <input disabled id="username" name="username" value="<?php echo Input::post('username', $user->username); ?>">
		    ...
		    <p>
		        ...
		        <input disabled id="email" name="email" value="<?php echo Input::post('email', $user->email); ?>">
